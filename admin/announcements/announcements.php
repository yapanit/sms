...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav pl-2 pt-4 mr-auto sidenav" id="navAccordion">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="announcements.php"><i class="fa fa-newspaper-o"></i> Announcements</a>
                </li>
                <!--  -->
                ...
                <div class="panel-heading my-1">
                    <div class="row">
                        ...
                        <div class="col-md-6" align="right">
                            <button type="button" name="add_data" id="add_data" class="btn btn-success btn-xs">Create Post</button>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript" language="javascript" src="announcements.js"> </script> <!-- need -->
